...
const styles = StyleSheet.create({
  ...
  loadingText: { fontSize: 14, color: '#7A4528', fontWeight: '600' },
  errorTitle:  { fontSize: 16, fontWeight: '700', color: '#A03020' },

  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 },
  title:  { fontSize: 22, fontWeight: '900', color: '#1C1008' },
  subtitle: { fontSize: 13, color: '#7A4528', marginTop: 3 },

  addButton: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#B5822A',
    borderRadius: 100, paddingHorizontal: 14, paddingVertical: 9, gap: 6,
  },
  addButtonText: { color: '#FDF6EC', fontWeight: '700', fontSize: 13 },

  successBanner: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#EBF4EE',
    borderWidth: 1, borderColor: '#9FCFB4', borderRadius: 14, padding: 12, marginBottom: 16, gap: 8,
  },
  successText: { color: '#3B6E52', fontSize: 13, fontWeight: '600' },
  errorBanner: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#FAECEA',
    borderWidth: 1, borderColor: '#E8A898', borderRadius: 14, padding: 12, marginBottom: 16, gap: 8,
  },
  errorText: { color: '#A03020', fontSize: 13, fontWeight: '600' },

  emptyState:   { alignItems: 'center', paddingVertical: 56, gap: 12 },
  emptyIcon:    { width: 72, height: 72, borderRadius: 18, backgroundColor: '#F7EDD8', borderWidth: 1.5, borderColor: '#DEC07A', alignItems: 'center', justifyContent: 'center' },
  emptyTitle:   { fontSize: 17, fontWeight: '800', color: '#1C1008' },
  emptySubtitle:{ fontSize: 13, color: '#7A4528' },

  card: {
    backgroundColor: '#F5E9D4', borderRadius: 14, borderWidth: 1.5, borderColor: '#EDD9BC',
  ...
  videoIcon:   { width: 40, height: 40, borderRadius: 10, backgroundColor: '#F7EDD8', borderWidth: 1, borderColor: '#DEC07A', alignItems: 'center', justifyContent: 'center' },
  cardTitle:   { fontSize: 15, fontWeight: '700', color: '#1C1008' },
  cardDesc:    { fontSize: 12, color: '#7A4528', marginTop: 2 },
  deleteBtn:   { padding: 7, borderRadius: 6, backgroundColor: '#FAECEA', borderWidth: 1, borderColor: '#E8A898' },
  ...
  viewCount:   { fontSize: 11, color: '#7A4528', fontWeight: '600' },

  rejectionBox: { marginTop: 10, backgroundColor: '#FAECEA', borderRadius: 8, padding: 8, borderWidth: 1, borderColor: '#E8A898' },
  rejectionText:{ fontSize: 12, color: '#A03020', fontWeight: '600' },

  modalOverlay:    { flex: 1, backgroundColor: 'rgba(28,16,8,0.6)', justifyContent: 'flex-end' },
  modalContainer:  { backgroundColor: '#F5E9D4', borderTopLeftRadius: 18, borderTopRightRadius: 18, borderWidth: 1.5, borderColor: '#EDD9BC', padding: 24 },
  modalTitle:      { fontSize: 16, fontWeight: '900', color: '#1C1008', marginBottom: 20 },
  label:           { fontSize: 11, fontWeight: '800', color: '#7A4528', marginBottom: 6, marginTop: 14, textTransform: 'uppercase', letterSpacing: 1.2 },
  input:           { borderWidth: 1.5, borderColor: '#EDD9BC', borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, fontSize: 14, color: '#1C1008', backgroundColor: '#FDF6EC' },
  textArea:        { height: 80, textAlignVertical: 'top' },
  videoPicker:     { flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1.5, borderColor: '#DEC07A', borderRadius: 14, padding: 14, backgroundColor: '#F7EDD8' },
  videoPickerText: { fontSize: 14, color: '#3D2010', fontWeight: '600' },

  modalButtons:  { flexDirection: 'row', gap: 12, marginTop: 24, marginBottom: 8 },
  cancelButton:  { flex: 1, borderWidth: 1.5, borderColor: '#EDD9BC', borderRadius: 100, paddingVertical: 12, alignItems: 'center', backgroundColor: '#FDF6EC' },
  cancelText:    { fontSize: 14, color: '#7A4528', fontWeight: '700' },
  submitButton:  { flex: 1, backgroundColor: '#B5822A', borderRadius: 100, paddingVertical: 12, alignItems: 'center' },
  submitText:    { fontSize: 14, color: '#FDF6EC', fontWeight: '800' },
});